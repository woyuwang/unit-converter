...
class _MainViewState extends State<MainView> {
  ...
  List<Category> _basicCategories = [
    ...
    Category('Current', Icon(NovaIcons.battery_charging_1),
      [
        Unit('ampere', 'A', 0, 1, 0),
        Unit('electromagnetic unit, abampere', 'abamp', 0, 10, 0),
        Unit('esu per second, statampere', 'esu/s', 0, 0.0000000003335641, 0),
      ],
    ),
  ...
  List<Category> _financeCategories = [
    ...
    //  [],
    //),
    Category('Currency Unimplemented', Icon(NovaIcons.location_pin_bank_2),
      [],
    ),
  ];

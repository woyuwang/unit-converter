    ...
    return MaterialApp(
      theme: ThemeData(
        ...
        snackBarTheme: SnackBarThemeData(
          backgroundColor: Storage.darkMode ? Color.fromRGBO(150, 150, 150, 1) : Color.fromRGBO(50, 50, 50, 1),
        ),
    ...
    Storage.categories = [
      ...
      BasicCategory('Power', NovaIcons.flash,
        [
          ...
          Unit('Atmosphere-Cubic Feet/Minute', 'atm cfm', 0, 47.82007468224, 0),
          Unit('Liter-Atmosphere/Minute', 'L·atm/min', 0, 1.68875, 0),
        ],
        color: Colors.pink,
      ),
      BasicCategory('Dynamic Viscosity', NovaIcons.water_droplet,
        [
          Unit('Pascal Pecond', 'Pa·s', 0, 1, 0),
      ...
      BasicCategory('Charge', NovaIcons.cursor_arrow_1,
        [
          ...
          Unit('Atomic Unit of Charge', 'au', 0, 0.0000000000000000001602176, 0),

    ...
    Storage.categories = [
      ...
      BasicCategory('Data', NovaIcons.cloud,
        [
          ...
          Unit('Byte', 'B', 0, 1/8, 0),
          Unit('Kilobyte', 'kB', 0, 1/8192, 0),
          Unit('Megabyte', 'MB', 0, 1/8388608, 0),
          Unit('Gigabyte', 'GB', 0, 1/8589934592, 0),
          Unit('Terabyte', 'TB', 0, 1/(8589934592 * 1024), 0),
          Unit('Petabyte', 'PB', 0, 1/(8589934592 * 1024 * 1024), 0),
          Unit('Crumb', '', 0, 1/2, 0),
          Unit('Nibble', '', 0, 1/4, 0),
